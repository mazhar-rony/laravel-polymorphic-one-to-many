    ...
    <div class="container" style="padding-top: 10px;">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <a href="{{ asset('/posts')}}" class="btn btn-success offset-md-8"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Show All Posts</a>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ asset('/posts/'.$post->id)}}" class="btn btn-secondary">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
